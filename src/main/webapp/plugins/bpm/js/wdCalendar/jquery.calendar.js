...
(function($) {
    ...
    $.fn.bcalendar = function(option) {
        var def = {
            ...
            datestrshow:dateFormat.call(new Date(),i18n.xgcalendar.dateformat.fulldayshow),//+" - "+dateFormat.call(new Date(new Date().getTime()+6*24*60*60*1000),i18n.xgcalendar.dateformat.Md3),
            ...
            enableDrag: true, 
            loadDateR: [],
            isSelectConflict:function(start, end){return false},
            isCanCancel:function(data){return false},
            startTime:0,
            endTime:24
        };
        ...
        var __SCOLLEVENTTEMP = "<DIV style=\"WIDTH:${width};top:${top};left:${left};\" title=\"${title}\" class=\"chip chip${i} ${drag}\"><div class=\"dhdV\" style=\"display:none\">${data}</div><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}\" class=ct>&nbsp;</DIV><DL style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BACKGROUND-COLOR:${bgcolor1}; BORDER-TOP-COLOR: ${bdcolor}; HEIGHT: ${height}px; BORDER-RIGHT-COLOR:${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\"><DT style=\"BACKGROUND-COLOR:${bgcolor2}\">${starttime} - ${endtime} ${icon}</DT><DD><SPAN>"+i18n.xgcalendar.event+": ${content}</SPAN></DD><DD><SPAN>"+i18n.xgcalendar.orderMan+": ${orderMan}</SPAN></DD><DD><SPAN>"+i18n.xgcalendar.orderState+": ${orderState}</SPAN></DD><DD><SPAN>${meetClass}</SPAN></DD><DIV class='resizer' style='display:${redisplay}'><DIV class=rszr_icon>&nbsp;</DIV></DIV></DL><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BACKGROUND-COLOR:${bgcolor1}; BORDER-TOP-COLOR: ${bdcolor}; BORDER-RIGHT-COLOR: ${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\" class=cb1>&nbsp;</DIV><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BORDER-TOP-COLOR:${bdcolor}; BORDER-RIGHT-COLOR:${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\" class=cb2>&nbsp;</DIV></DIV>";
        ...
        function BuildDaysAndWeekView(startday, l, events, config) {
            ...
            //html.push("<table id=\"tttttttt\" style=\"height: 463px\" id=\"tgTable\" class=\"tg-timedevents\" cellspacing=\"0\" cellpadding=\"0\"><tbody>");
            html.push("<table id=\"tttttttt\" id=\"tgTable\" class=\"tg-timedevents\" cellspacing=\"0\" cellpadding=\"0\"><tbody>");
        ...
        function BuildWT(ht, dayarrs, events, dMax) {
            ...
            if(option.view=="week"){
            	...
            	var meetObj = option.meetJson;
            	ht.push("<tr>", "<th width=\"60\" rowspan=\"3\">&nbsp;</th>");
	            for (var i = 0; i < meetObj.length; i++) {
	                var ev, title, cl;
                    ev = "";
                    title = "";
                    cl = "";
	                ht.push("<th abbr='", dateFormat.call(dayarrs[0].date, i18n.xgcalendar.dateformat.fulldayvalue), "' class='gcweekname' scope=\"col\"><div title='", title, "' ", ev, " class='wk-dayname'><span class='", cl, "'>", meetObj[i].display, "</span></div></th>");
	            }
	            ht.push("<th width=\"16\" rowspan=\"3\">&nbsp;</th>");
	            ht.push("</tr>"); //end tr1;
	            ht.push("</tbody></table></div></td></tr>"); // stgrid end //wvAd end //td2 end //tr2 end
	            ...
	            ht.push("<td style=\"height: 5px;\"");
	            if (meetObj.length > 1) {
	                ht.push(" colSpan='", meetObj.length, "'");
	            }
	            ht.push("></td>");
	            ht.push("</tr>");
            }
        ...
        function BuildDayScollEventContainer(ht, dayarrs, events) {
			...
			if(option.view == "week"){
            	...
            	for (var i = 0; i < l; i++) {
	                ...
	                // Today
	                var dynamicHeigth = (option.endTime-option.startTime)*42;
	                if (istoday) {
	                    ht.push("<div style=\"margin-bottom: -"+dynamicHeigth+"px; height:"+dynamicHeigth+"px\" class=\"tg-today\">&nbsp;</div>");
	                }
	                //var eventC = $(eventWrap);
	                //onclick=\"javascript:FunProxy('rowhandler',event,this);\"
	                ht.push("<div  style=\"margin-bottom: -"+dynamicHeigth+"px; height: "+dynamicHeigth+"px\" id='tgCol", i, "' class=\"tg-col-eventwrapper\">");
				...
				var l = meetObj.length;
				var newevents = [];
				var level2;
				for(var j = 0 ; j < l; j++){
					level2=[];
					for(var k = 0 ; k < events[0].length; k ++){
						if((events[0])[k].event[13] == meetObj[j].meetRoom){
							level2.push(events[0][k]);
						}
					}
					newevents.push(level2);
				}
				for (var i = 0; i < l; i++) {
	                ht.push("<td class=\"tg-col\" ch='qkadd' abbr='", dateFormat.call(dayarrs[0].date, i18n.xgcalendar.dateformat.fulldayvalue), ":",meetObj[i].meetRoom,"'>");
	                var istoday = dateFormat.call(dayarrs[0].date, "yyyyMMdd") == dateFormat.call(new Date(), "yyyyMMdd");
	                // Today
	                var dynamicHeigth = (option.endTime-option.startTime)*42;
	                if (istoday) {
	                    ht.push("<div style=\"margin-bottom: -"+dynamicHeigth+"px; height:"+dynamicHeigth+"px\" class=\"tg-today\">&nbsp;</div>");
	                ...
	                //onclick=\"javascript:FunProxy('rowhandler',event,this);\"
	                ht.push("<div  style=\"margin-bottom: -"+dynamicHeigth+"px; height: "+dynamicHeigth+"px\" id='tgCol", i, "' class=\"tg-col-eventwrapper\">");
	                BuildEvents(ht, newevents[i], dayarrs[0]);
	                ht.push("</div>");
        ...
        function BuildEvents(hv, events, sday) {
            for (var i = 0; i < events.length; i++) {
                ...
                */
                var tt = BuildDayEvent(events[i].event[7], events[i], i);
                hv.push(tt);
            }
        }
        function getTitle(event) {
            var timeshow, locationshow, attendsshow, eventshow,orderManShow;
            ...
            orderManShow = event[0]==-1 ? option.currentUserName : ((event[11] != undefined && event[11] != "") ? event[11] : "");
            orderState = event[0]==-1 ? option.defaultOrderState : ((event[12] != undefined && event[12] != "") ? event[12] : "");
            var ret = [];
            if (event[4] == 1) {
...
//            
//            ret.push($.browser.mozilla?"":"\r\n",i18n.xgcalendar.orderMan + ":",orderManShow,$.browser.mozilla?"":"\r\n",i18n.xgcalendar.orderState+":",orderState);
//            if (attendsshow != "") {
...
//            }
            ...
            ret.push("\r\n",i18n.xgcalendar.orderMan + ":",orderManShow,"\r\n",i18n.xgcalendar.orderState+":",orderState);
            if (attendsshow != "") {
                ret.push("\r\n", i18n.xgcalendar.participant + ":", attendsshow);
            }
            return ret.join("");
        ...
        function BuildDayEvent(theme, e, index) {
            var p = { bdcolor: theme[0], bgcolor2: theme[0], bgcolor1: theme[1], width: "70%", icon: "", title: "", data: "" };
            p.starttime = pZero(e.st.hour) + ":" + pZero(e.st.minute);
            p.endtime = pZero(e.et.hour) + ":" + pZero(e.et.minute);
            p.content = e.event[1];
            p.title = getTitle(e.event);
            p.orderMan = e.event[0]==-1 ? option.currentUserName : e.event[11];
            p.orderState = e.event[0]==-1 ? option.defaultOrderState : e.event[12];
            p.meetClass = e.event[14]!=undefined?i18n.xgcalendar.meetClass+": "+e.event[14]:"";
            p.data = e.event.join("$");
            var icons = [];
...
//            p.width = (e.aQ * 100) + "%";
        ...
        function populate() {
            ...
            option.eventItems.splice(0,option.eventItems.length);
            if (option.url && option.url != "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {//function(datastr) {									
                        ...
                        if (data != 'undefind' && data.error != null) {
        ...
        //utils goes here日视图跳转
        function weekormonthtoday(e) {
        	$("#showweekbtn").removeClass("fcurrent");
        	$("#showdaybtn").addClass("fcurrent");
        	$("#showSelectMeet").css("display","none"); 
            var th = $(this);
            var daystr = th.attr("abbr");
            $("#txtdatetimeshow").text(dateFormat.call(strtodate(daystr + " 00:00"), i18n.xgcalendar.dateformat.fulldayshow))
        ...
        function gP(h, m) {
            return h * 42 + parseInt(m / 60 * 42)-option.startTime*42;
        }
        function gW(ts1, ts2) {
            var t1 = ts1 / 42;
            var t2 = parseInt(t1);
        ...
        function Tp(temp, dataarray) {
        	if(dataarray.drag == "drag-chip")
        	{
        		dataarray.orderMan = option.currentUserName;
        		dataarray.orderState = option.defaultOrderState;
        		dataarray.icon="";
        		dataarray.meetClass="";
        	}
            return temp.replace(/\$\{([\w]+)\}/g, function(s1, s2) { var s = dataarray[s2]; if (typeof (s) != "undefined") { return s; } else { return s1; } });
        }
        function Ta(temp, dataarray) {
            return temp.replace(/\{([\d])\}/g, function(s1, s2) { var s = dataarray[s2]; if (typeof (s) != "undefined") { return encodeURIComponent(s); } else { return ""; } });
        }
        ...
        function dayshow(e, data) {
            ...
            if (data != null) {
            	//var isCanCancel = option.isCanCancel(data);
            	/*$.ajax({
                	url:'newMeetingOrder.action?method=isCanCancel',
                	data:{meetId:data[0]},
                	async:false,
                ...
                if (option.isCanCancel(data)) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" title="'
                    	...
                    	+'</div></div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose2" class="bubble-closebutton"></div><div id="prong1" class="prong"><div class=bubble-sprite></div></div></div>';
...
//                		 +'<tr><td class=cb-value><div id="bbit-cs-buddle-timeshow"></div></td></tr></tbody></table><div class="bbit-cs-split"><input id="bbit-cs-id" type="hidden" value=""/>[ <span id="bbit-cs-delete" class="lk">'
//                     	+ i18n.xgcalendar.i_delete + '</span> ]&nbsp;'
//                     	+'</div></div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose2" class="bubble-closebutton"></div><div id="prong1" class="prong"><div class=bubble-sprite></div></div></div>';
...
//                        ss.push("-", dateFormat.call(data[2], "HH:mm"));
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                //temparr.push('<SPAN id="bbit-cal-editLink" class="lk">'+i18n.xgcalendar.update_detail+'"<StrONG>&gt;&gt;</StrONG></SPAN>');
                ...
                calbutton.click(function(e) {
                    ...
                    var date = ($("#bbit-cal-start").val().split(" "))[0]+" ";
                    var datestart = date+$("#MEET_START").val();
                    var dateend = date+$("#MEET_END").val();
                    var sd = strtodate(datestart);
                    var ed = strtodate(dateend);
                    if(sd > ed){
                    	hiAlert("会议开始时间不能大于结束时间！","会议时间");
                    	return false;
                    }
                    var allday = $("#bbit-cal-allday").val();
                    var f = /^[^\$\<\>]+$/.test(what);
                    if (!f) {
                        return hiAlert(i18n.xgcalendar.invalid_title,"会议主题",function(){
                        	 $("#bbit-cal-what").focus();
                             option.isloading = false;
                             return false;
                        });
                    ...
                    var meetRoom;
                    if(option.view=="week"){
	                     meetRoom = $("#selectMeet").val()
                    }
                    else{
                    	meetRoom = option.meetRoom;
                    }
                    var param = [{ "name": "CalendarTitle", value: what },
						{ "name": "meetStart", value: datestart },
						{ "name": "meetEnd", value: dateend },
						{ "name": "IsAllDayEvent", value: allday },
						{ "name": "timezone", value: zone},
						{ "name": "meetRoom", value: meetRoom}
						];
                    if (option.extParam) {
                        for (var pi = 0; pi < option.extParam.length; pi++) {
                            param[param.length] = option.extParam[pi];
                    ...
                    if (option.quickAddHandler && $.isFunction(option.quickAddHandler)) {
                        ...
                        /*$.ajax({
                        	url:option.quickAddUrl,
                        	data:param,
                        	async:false,
                        	success:function(data) {
                            if (!eval("("+data+")").isTrueOrFalse) {
                                hiAlert("会议时间冲突，请重新选择！","会议时间");
                                flag = true;
                            }
                        }});
                        if(flag){
                        ...
                        newdata.push(-1, what);
                        var diff = DateDiff("d", sd, ed);
                        newdata.push(sd, ed, 0,0,0);
                        newdata.push(option.theme, 0, "", "","","",option.meetRoom); //meetRoom
                        tId = Ind(newdata);
                        realsedragevent();
                        render();
                        if($.isFunction(option.quickAdd)){
                        	option.quickAdd(datestart,dateend,meetRoom,what);
                        } else  {
                        	newWin = window.open(option.projectName+"/bpm/bpmAction.action?method=startProcess&intanceInfo.processName=meetOrder&MEET_START="+datestart+"&MEET_END="+dateend+"&MEET_ROOM="+meetRoom+"&MEET_NAME="+encodeURI(encodeURI(what)),"open","toolbar=0,location=0,status=1,menubar=0,scrollbars=1,resizable=1,width=800,height=700,top=3,left=563,z-look=yes");
                       		itvl = setInterval("if(newWin.closed == true) {clearInterval(itvl);$('#gridcontainer').reload();}", 500);
                        }
                    }
                });
                lbtn.click(function(e) {
            ...
            $("#bbit-cal-buddle-timeshow").html(populateDate(start,end));
            $("#MEET_START").click(function(){
            	WdatePicker({el:$dp.$('MEET_START'),dateFmt:'HH:mm',skin:'whyGreen',isShowClear:false,readOnly:true,minDate:'08:00:00',maxDate:'23:59:00'});
        	});
        	$("#MEET_END").click(function(){
        		WdatePicker({el:$dp.$('MEET_END'),dateFmt:'HH:mm',skin:'whyGreen',isShowClear:false,readOnly:true,minDate:'08:00:00',maxDate:'23:59:00'});
        	});
        ...
        function populateDate(start,end){
        	var str = "";
        	var startday = dateFormat.call(start, getymformat(start, null, null, true));
        	var start = dateFormat.call(start,"HH:mm");
        	var end = dateFormat.call(end,"HH:mm");
        	str+='<div>'+startday+'</div>';
        	str+='<div>开始时间：<input name="MEET_START" style="width:60px" id="MEET_START" type="text" value="'+start+'" class="Wdate" notEmpty="yes" /></div>';
        	str+='<div>结束时间：<input name="MEET_END" style="width:60px" id="MEET_END" type="text" value="'+end+'" class="Wdate" notEmpty="yes" /></div>';
        ...
        function dragStart(type, e) {
        	e.pageY = e.pageY+option.startTime*42;
            var obj = $(this);
        ...
        function dragMove(e) {
            ...
            if (_dragdata) {
                if (e.pageX < 0 || e.pageY < 0
					...
					|| e.pageY >= document.documentElement.clientHeight+option.startTime*42) {
                    dragEnd(e);
                    return false;
                }
                var d = _dragdata;
            ...
            if (_dragdata) {
                ...
                switch (d.type) {
                    case 1: //day view
                        ...
                        var end;
                        if(option.view=="day"){
                        	var temp = d.target.attr("abbr").split(":");
                        	start = strtodate(temp[0] + " " + d.cgh.sh + ":" + d.cgh.sm);
	                        end = strtodate(temp[0] + " " + d.cgh.eh + ":" + d.cgh.em);
	                        option.meetRoom = temp[1];//拖动完成之后讲会议室Id放入option
                        }else{
	                        start = strtodate(d.target.attr("abbr") + " " + d.cgh.sh + ":" + d.cgh.sm);
	                        end = strtodate(d.target.attr("abbr") + " " + d.cgh.eh + ":" + d.cgh.em);
	                        option.meetRoom = $("#selectMeet").val() || option.meetRoom;
                        }
                        _dragevent = function() {
                        	$("#" + wrapid).remove();
                        	$("#bbit-cal-buddle").css("visibility", "hidden");
                        };
                        option.isSelectConflict(dateFormat.call(start, "yyyy-MM-dd HH:mm:ss"), dateFormat.call(end, "yyyy-MM-dd HH:mm:ss"),option.meetRoom,function(isConflict){
                        	if(!isConflict){
                                ...
                                option.quickAdd(dateFormat.call(start, "yyyy-MM-dd HH:mm"),dateFormat.call(end, "yyyy-MM-dd HH:mm"),meetRoom);
                        	}
                        });
                        break;
                    case 2: //week view
