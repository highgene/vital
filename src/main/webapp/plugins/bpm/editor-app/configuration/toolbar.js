...
KISBPM.TOOLBAR_CONFIG = {
    "items" : [
           {
        	   "type" : "button",
        	   "title" : "TOOLBAR.ACTION.BACK",
        	   "cssClass" : "editor-icon editor-icon-back",
        	   "action" : "KISBPM.TOOLBAR.ACTIONS.back"
           },
           {
        	   "type" : "button",
        	   "title" : "TOOLBAR.ACTION.OPEN",
        	   "cssClass" : "editor-icon editor-icon-open",
        	   "action" : "KISBPM.TOOLBAR.ACTIONS.openModel"
           },
        {
            "type" : "button",
