...
KISBPM.URL = {
    ...
    updateModel: function(modelId) {
    	return ACTIVITI.CONFIG.contextRoot + '/bpm/model/update/' + modelId ;
    },
    ...
    checkKey: function(key){
    	return ACTIVITI.CONFIG.contextRoot + '/bpm/model/checkKey/'+key;
    },
    checkTable: function(checkTable){
    	return ACTIVITI.CONFIG.contextRoot + '/bpm/model/checkTable/'+checkTable;
    }
