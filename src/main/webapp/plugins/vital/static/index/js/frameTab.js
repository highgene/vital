function CreateDiv(tabid, url, name,reload) {
	...
	if (document.getElementById("div_" + tabid) == null) {
		...
		tab.className = "crent";
		tab.id = tabid;
		var litxt = "<span><a href=\"javascript:;\" onclick=\"javascript:CreateDiv('" + tabid + "','" + url + "','" + name + "'," + reload + ")\" title=" + name + " class=\"menua\">" + name + "</a><a class=\"menua_cloes\" data-action=\"close\" onclick=\"RemoveDiv('" + tabid + "')\" href=\"javascript:;\" title=\"关闭当前窗口\"><i class=\"ace-icon fa fa-times-circle\"></i></a></span>";
		tab.innerHTML = litxt;
