...
import com.hhwy.vital.common.security.Digests;
...
import com.hhwy.vital.modules.sys.dao.*;
...
public class SystemService extends BaseService implements InitializingBean {
    ...
    @Transactional(readOnly = false)
    public void updatePasswordById(String id, String loginName, String newPassword, int isChangingPassword) {
        User user = new User(id);
        user.setPassword(entryptPassword(newPassword));
        user.setIsChangingPassword(isChangingPassword);
        userDao.updatePasswordById(user);
        // 清除用户缓存
        user.setLoginName(loginName);
        UserUtils.clearCache(user);
    ...
    @Transactional(readOnly = false)
    public void updateOfficeSort(Office office) {
        officeDao.updateSort(office);
        // 清除用户菜单缓存
