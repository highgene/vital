 ...
 */
package com.hhwy.vital.common.service;

import com.google.common.collect.Lists;
import com.hhwy.vital.common.persistence.BaseEntity;
...
//		}
	 ...
	 * @example
	 * 		dataScopeFilter(user, "dsf", "id=a.office_id", "id=a.create_user");
...
//				sqlString.append(" AND EXISTS (SELECT 1 FROM t_vital_organization");
...
//				sqlString.append(" AND EXISTS (SELECT 1 FROM sys_role_office ro123456, t_vital_organization o123456");
